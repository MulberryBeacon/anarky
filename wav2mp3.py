...
# -------------------------------------------------------------------------------------------------
from audio import encode_wav_mp3, set_cover, EXTENSIONS
...
INFO_HELP = ("Usage: wav2mp3 [OPTION] [input-files] [-d] [destination]\n\n" +
			"OPTIONS:\n" +
...
INFO_VERSION = "wav2mp3 version 0.0.1\n"
...
def run(arguments):
	...
	if not source_flag:
		print ERROR_NO_FILES_GIVEN.format(EXTENSIONS["wav"])
		sys.exit()
